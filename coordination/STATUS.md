...
- **Working on:** #16 (WP-16) cross-reference sweep tool (`tools/xref_check.py`, branch `agent-gemini/issue-16`). PR #26 opened for review.
- **Waiting for:** Claude review on PR #26.
