...
| **Codex** (desktop app on the founder's machine) | `agent:codex` | Implementation against frozen specs, with tests; second reviewer on specs and on Claude's and Gemini's PRs; CI and deployment scripts | Edit frozen specs without a version bump; reopen logged decisions; merge |
